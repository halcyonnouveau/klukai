...
pub struct CorrosionClient {
    ...
    pool: klukai_types::sqlite_pool::RusqlitePool,
}
...
impl CorrosionClient {
    pub fn new<P: AsRef<Path>>(api_addr: SocketAddr, db_path: P) -> Self {
        Self {
            ...
            pool: klukai_types::sqlite_pool::Config::new(db_path.as_ref())
                .max_size(5)
                .create_pool()
    ...
    pub fn pool(&self) -> &klukai_types::sqlite_pool::RusqlitePool {
        &self.pool
    }
}
