...
macro_rules! dbvr {
    ($start:literal, $end:literal) => {
        $crate::base::CrsqlDbVersionRange::new(
            $crate::base::CrsqlDbVersion($start),
            $crate::base::CrsqlDbVersion($end),
        )
    };
}
...
macro_rules! dbvri {
    ($start:literal, $end:literal) => {
        $crate::base::CrsqlDbVersion($start)..=$crate::base::CrsqlDbVersion($end)
    };
}
...
macro_rules! dbsr {
    ($start:literal, $end:literal) => {
        $crate::base::CrsqlSeqRange::new(
            $crate::base::CrsqlSeq($start),
            $crate::base::CrsqlSeq($end),
        )
    };
}
...
macro_rules! dbsri {
    ($start:literal, $end:literal) => {
        $crate::base::CrsqlSeq($start)..=$crate::base::CrsqlSeq($end)
    };
}
